...
public class DAOmethods {
    ...
    public ArrayList<VO> selectAll(){
        ...
        String sql = "select * from schedule_t order by date desc";
    ...
    public boolean dateChk(String date){
        String sql = "select * from schedule_t where date=?";
        String[] arr = {date};
    ...
    public void insertPlan(String date,String content){
        String sql = "insert into schedule_t values(null,?,?)";
    ...
    public void modifyPlan(String date,String content){
        String sql = "update schedule_t set content=? where date=?";
    ...
    public void deletePlan(String date){
        String sql = "delete from schedule_t where date=?";
        String[] arr = {date};
        db.execSQL(sql,arr);
        db_close();
    }
